...
// const getSortedFriends = users => {return users.flatMap(user => user.friends)
...
const getTotalBalanceByGender = (users, gender) => { return users.filter( user => user.gender === gender)
